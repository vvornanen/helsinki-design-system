...
Optionally, an icon can be included in dropdown. The icon is always placed at the left side of the dropdown. Icons can be used to emphasise function of the dropdown (e.g. date and time). However, if icons meaning is not commonly clear, it most likely should be left out. The dropdown label should be always included even if icon is used.
